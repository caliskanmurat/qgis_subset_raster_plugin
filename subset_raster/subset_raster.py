...
class SubsetRaster:
    ...
    def subsetRaster(self, input_raster_path, output_folder_path, output_name, creationOptions, minX_, minY_, maxX_, maxY_):
        srs1 = CRS.from_wkt(self.srs_wkt)
        ...
        if self.dlg.rb_gtiff.isChecked():
            output_file_path = os.path.join(output_folder_path, output_name+"_clipped.tif")
            ...
            output_file_path = os.path.join(output_folder_path, output_name+"_clipped.vrt")
    ...
    def executeSubset(self):
        ...
        for i in range(ql_count):
            ...
            output_name = os.path.split(input_raster_path)[-1].split(".")[0]
            
            _ = self.subsetRaster(input_raster_path, output_folder_path, output_name, creationOptions, minX_, minY_, maxX_, maxY_)
